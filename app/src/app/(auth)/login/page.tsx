    ...
    <Card className="shadow-lg border-0 rounded-2xl overflow-hidden">
      <div className="bg-gradient-to-r from-indigo-600 to-violet-600 p-6 text-white">
        <CardHeader className="p-0">
          ...
          <CardDescription className="text-indigo-100 mt-1">Welcome back. Sign in to continue.</CardDescription>
        </CardHeader>
      </div>
      <CardContent className="p-6 space-y-4">
        {/* Google Sign In — Primary */}
        <button
          className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 font-bold text-sm py-3 rounded-xl text-slate-700 transition-all shadow-sm"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Button type="submit" className="w-full rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5" disabled={loading}>
